...
const Window = ({ title, children, onClose, isOpen, zIndex, onFocus, icon }) => {
    ...
    return (
        ...
        >
            ...
            {/* Content Area */}
            <div className="flex-1 bg-white border-2 border-gray-500 border-b-white border-r-white shadow-inner p-4 overflow-auto">
